  ...
  $.widget(
    ...
    $.extend({}, $.ui.sortable.prototype, {
      ...
      _create: function () {
        ...
        this.element.data(
          "ui-sortable",
          this.element.data("mjs-nestedSortable"),
        );
      ...
      _mouseDrag: function (event) {
        ...
        for (i = this.items.length - 1; i >= 0; i--) {
          ...
          if (
            ...
            if (
              o.isTree &&
              $(itemElement).hasClass(o.collapsedClass) &&
              o.expandOnHover
            ) {
              if (!this.hovering) {
        ...
        if (
          ...
          if (o.isTree && helperIsNotSibling) {
            parentItem
              .removeClass(
                this.options.branchClass + " " + this.options.expandedClass,
              )
      ...
      _mouseStop: function (event) {
        ...
        this._sort_current = this.domPosition.prev
          ? $(this.domPosition.prev).next().index()
          : 0;
